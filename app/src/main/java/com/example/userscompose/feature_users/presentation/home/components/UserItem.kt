package com.example.userscompose.feature_users.presentation.home.components
...
import com.example.userscompose.feature_users.presentation.home.HomeEvent
...
fun UserItem(
    ...
    Card(
        ...
        Row(
            ...
            Row { IconButton(onClick = onEditUser) {
                Icon(
